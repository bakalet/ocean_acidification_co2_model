...
def simulate_ph(t_eval, p1, p2, p3):  #Creation de la fonction pour fitter
    ...
    pH_simulé = -np.log10(np.maximum(solution.y[2], epsilon))  # Protection contre le log(0)
...
print(f"Valeurs optimisées : k1 = {k1_opt:.2e}, k3 = {k3_opt:.2e}, kla = {kla_opt:.2e}")
